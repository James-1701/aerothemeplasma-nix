...
kdePackages.plasma-workspace.overrideAttrs (oldAttrs: {
  pname = "aerothemeplasma-workspace";
  ...
  postPatch = ''
    ...
    setOutputName plasmashell atplasmashell
    ...
    substituteInPlace shell/plasma-plasmashell.service.in \
      --replace-fail "BINDIR@/plasmashell" "BINDIR@/atplasmashell"
    ...
    mv shell/plasma-plasmashell.service.in shell/atplasma-plasmashell.service.in
    substituteInPlace shell/CMakeLists.txt startkde/systemd/atplasma-core.target \
      --replace-fail "plasma-plasmashell.service" "atplasma-plasmashell.service"

    # rename desktop file and fix its plasmashell reference
    mv shell/org.kde.plasmashell.desktop.cmake shell/io.gitgud.wackyideas.atplasmashell.desktop.cmake
    substituteInPlace shell/CMakeLists.txt \
      --replace-fail "org.kde.plasmashell.desktop" "io.gitgud.wackyideas.atplasmashell.desktop"
    substituteInPlace shell/io.gitgud.wackyideas.atplasmashell.desktop.cmake \
      --replace-fail "PREFIX@/bin/plasmashell" "PREFIX@/bin/atplasmashell"
    ...
    substituteInPlace shell/atplasma-plasmashell.service.in \
